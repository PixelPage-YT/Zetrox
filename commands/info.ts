    ...
    try {
        ...
        await i.respond({
            embeds: [
                {
                    'title':
                        ':information_source: Infos über Zetrox :information_source:',
                    'color': 44469,
                    'fields': [
                        {
                            'name': 'Ping',
                        ...
                        },
                        {
                            ...
                            'value': '<t:' + Math.floor(startDate / 1000) +
                                ':R>',
                        },
                        {
                            'name': 'Serveranzahl',
                            'value': (await client.guilds.array()).length
                                .toString(),
                        },
                        {
                            'name': 'Benutzeranzahl',
                        ...
                        },
                        {
                            ...
                            'value':
                                'Du kannst [hier](https://zetrox.neocities.org/home/datenschutz.html) sehen, welche Daten Zetrox sammelt.',
                        },
                        {
                            'name': 'Icons',
                            'value':
                                'Der Bot benutzt an verschiedenen Stellen Icons von [diesem](https://discord.gg/h9Huh6Dz7t) Server.',
                        },
                        {
                            'name': 'Programmiersprache und Bibliotheken',
                            'value':
                                'Der Bot ist in TypeScript geschrieben \nund benutzt die TypeScript Runtime Deno.\nDer Discord Client ist Harmony.\n\nTypeScript: https://typescriptlang.org/\nDeno: https://deno.land/\nHarmony: https://deno.land/x/harmony',
                        },
                    ],
                    'footer': {
