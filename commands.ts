...
export const commands: harmony.SlashCommandPartial[] = [
        ...
        'options': [
            {
                ...
                'name': 'invitekanal',
                'description':
                    'Setze einen Kanal, in den Wilkommensnachrichten geschrieben werden!',
                'options': [
                    {
                        'type': 7,
                        'name': 'channel',
            ...
            },
            {
                ...
                'name': 'antispamtime',
                'description':
                    'Setze eine Zeit, in der nur eine Nachricht zählt.',
                'options': [
                    {
                        'type': 4,
                        'name': 'time',
    ...
    },
    {
        ...
        'options': [
            ...
            },
            {
                ...
                'name': 'user',
                'description':
                    'Der Benutzer, dem etwas hinzugefügt werden soll.',
            },
        ],
    },
    {
    ...
    },
    {
        'name': 'emojiquiz',
        'description':
            'Errate den Begriff anhand von Emojis und bekomme Spielpunkte!',
    },
    {
        'name': 'quiz',
    ...
    },
    {
        ...
        'options': [
            ...
            },
            {
                ...
                'name': 'delete',
                'description':
                    'Löscht alle Statistik Nachrichten auf dem Server',
                'options': [],
            },
            {
                'type': 1,
    ...
    },
    {
        ...
        'options': [
            ...
            },
            {
                ...
                'name': 'sekunden',
                'description':
                    'Die Anzahl der Sekunden, wie lange ein Giveaway läuft.',
                'choices': [],
            },
            {
                'type': 4,
                'name': 'minuten',
                'description':
                    'Die Anzahl der Minuten, wie lang das Gewinnspiel läuft',
                'choices': [],
            },
            {
                'type': 4,
                'name': 'stunden',
                'description':
                    'Die Anzahl der Stunden, wie lang das Gewinnspiel läuft',
                'choices': [],
            },
            {
                'type': 4,
                'name': 'tage',
                'description':
                    'Die Anzahl der Tage, wie lang das Gewinnspiel läuft',
                'choices': [],
            },
        ],
    },
